  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved review as @review" do
        ...
        post :create, {:review => { "body" => "invalid value" }}, valid_session
        assigns(:review).should be_a_new(Review)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested review" do
        ...
        Review.any_instance.should_receive(:update_attributes).with({ "body" => "MyText" })
        put :update, {:id => review.to_param, :review => { "body" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the review as @review" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Review.any_instance.stub(:save).and_return(false)
        put :update, {:id => review.to_param, :review => { "body" => "invalid value" }}, valid_session
        assigns(:review).should eq(review)
      end
